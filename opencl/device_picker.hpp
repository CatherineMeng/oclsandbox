...
void parseArguments(int argc, char *argv[], cl_uint *deviceIndex, std::string& kernelFileName )
{
  for (int i = 1; i < argc; i++)
  {
    if (!strcmp(argv[i], "--list")) {
      ...
      std::cout << "      --kernel  <pathToKernelBinary.aocx> Specify the path to the percompiled kernel\n";
      std::cout << "\n";
      exit(0);
    }
  }
